            ...
            {isUserMenuOpen && (
              <>
                ...
                <div className="absolute right-0 mt-2 w-56 bg-popover border border-border rounded-md shadow-lg z-300 overflow-hidden">
                  ...
                  <div className="py-1">
                    <button
                      className="w-full px-4 py-2 text-left text-sm text-foreground hover:bg-muted transition-smooth flex items-center gap-3"
                      onClick={() => {
                  ...
                  <div className="border-t border-border py-1">
                    <button
                      className="w-full px-4 py-2 text-left text-sm text-error hover:bg-muted transition-smooth flex items-center gap-3"
                      onClick={() => {
                        handleLogout();
                        setIsUserMenuOpen(false);
                      }}
